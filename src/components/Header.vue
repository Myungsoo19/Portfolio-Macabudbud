...
const FacebookLink = 'https://web.facebook.com/javy.macabudbud.90';
const GithubLink = 'hhttps://github.com/Myungsoo19';
        ...
        <nav class="mx-auto max-w-screen-xl px-12 py-4">
            <div class="flex flex-row items-center justify-between">
                <router-link to="/" class="flex flex-col">
                    <h1 class="font-bold text-xl">Javy Macabudbud</h1>
                    <p class="font-light text-lg text-gray-600">BSIT 4B</p>
                </router-link>
                ...
                <div class="hidden lg:block">
                    <ul class="flex flex-row gap-8">
                        <li
                            :class="$route.name === 'home' ? 'text-blue-700 font-medium text-lg' : 'text-gray-700 hover:text-blue-700 font-normal text-lg'">
                            <router-link to="/">Home</router-link>
                        </li>
                        <li
                            :class="$route.name === 'about' ? 'text-blue-700 font-medium text-lg' : 'text-gray-700 hover:text-blue-700 font-normal text-lg'">
                            <router-link to="/about">About</router-link>
                        </li>
                        <li
                            :class="$route.name === 'projects' ? 'text-blue-700 font-medium text-lg' : 'text-gray-700 hover:text-blue-700 font-normal text-lg'">
                            <router-link to="/projects">Projects</router-link>
                        </li>
                        <li
                            :class="$route.name === 'contact' ? 'text-blue-700 font-medium text-lg' : 'text-gray-700 hover:text-blue-700 font-normal text-lg'">
            ...
            <div v-if="isOpenMenu" class="flex lg:hidden relative">
                ...
                <div class="bg-white flex flex-col absolute top-[18px] -left-[52px] w-screen gap-4 shadow-lg p-6 rounded">
                    ...
                    <router-link to="/contact"
                        :class="$route.name === 'contact' ? 'bg-gray-50 p-2 rounded-lg text-cyan-700 font-medium text-lg' : 'hover:bg-gray-50 p-2 text-gray-700 hover:text-cyan-700 font-normal text-lg'">
                        Contact
                    </router-link>
